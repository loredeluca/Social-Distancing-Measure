...
def find_center(four_points):
    ...
    chess_w, chess_h, _ = find_max_side(four_points)
...
def find_max_side(four_points):
    ...
    if chess_h == right_side:
        side_points = (four_points[1], four_points[2])
    else:
        side_points = (four_points[0], four_points[3])
    ...
    return chess_w, chess_h, side_points

def find_distance(p1,p2):
    #compute euclidean distance
    return np.sqrt((p1[0] - p2[0]) ** 2 + (p1[1] - p2[1]) ** 2)

def find_scale(four_points, bird_points):
    #method used to compute the scale values for height and width, very useful in all the bird view functions 

    bird_distance = np.sqrt((bird_points[0][0] - bird_points[3][0])**2 + (bird_points[0][1] - bird_points[3][1])**2)
    chess_distance = np.sqrt((four_points[0][0] - four_points[3][0])**2 + (four_points[0][1] - four_points[3][1])**2)

    scale_w = bird_distance / chess_distance

    bird_distance = np.sqrt((bird_points[2][0] - bird_points[3][0]) ** 2 + (bird_points[2][1] - bird_points[3][1]) ** 2)
    chess_distance = np.sqrt((four_points[2][0] - four_points[3][0]) ** 2 + (four_points[2][1] - four_points[3][1]) ** 2)

    scale_h = bird_distance / chess_distance

    min_value = int(min(scale_h,scale_w))

    print("SCALEW, SCALEH , picc: ", scale_w, scale_h, min_value)
    return scale_w/min_value, scale_h/min_value
...
def find_roi_straight(image,four_points,crop):
    ...
    # compute angles
    points1 = []
    points1.append(four_points[0])
    points1.append(four_points[3])
    points1.append(four_points[2])
    angle1 = find_angle(points1)
    points2 = []
    points2.append(four_points[3])
    points2.append(four_points[2])
    points2.append(four_points[1])
    ...
    bird_points.append([crop[0][0] + left, crop[0][1]]) #top-left
    bird_points.append([crop[0][0] + new_w - right, crop[0][1]]) #top_right
    bird_points.append([crop[0][0] + new_w, crop[0][1] + new_h]) #bottom_right
    bird_points.append([crop[0][0], crop[0][1] + new_h]) #bottom_left
...
def find_roi_counterclockwise(image,four_points,crop):
    ...
    points1.append(four_points[3])
    points1.append(four_points[0])
    points1.append(four_points[1])
    a = find_angle(points1)

    points2 = []
    points2.append(four_points[0])
    points2.append(four_points[1])
    points2.append(four_points[2])
    b = find_angle(points2)

    points3 = []
    points3.append(four_points[1])
    points3.append(four_points[2])
    points3.append(four_points[3])
    c = find_angle(points3)

    points4 = []
    points4.append(four_points[2])
    points4.append(four_points[3])
    points4.append(four_points[0])
    ...
    points5 = []
    points5.append(four_points[0])
    points5.append(point_inters1)
    points5.append((frame_w, 0))
    ...
    points6 = []
    points6.append(four_points[1])
    points6.append(inters_point2)
    points6.append((0, frame_h))
    ...
    points7 = []
    points7.append(four_points[2])
    points7.append(inters_point3)
    points7.append((0,0))
    ...
    points8 = []
    points8.append(four_points[0])
    points8.append(inters_point4)
    points8.append((0,0))
    ...
    bird_points.append([crop[0][0],crop[0][1] + up + Y1])  # left
    bird_points.append([crop[0][0] + left + X2, crop[0][1]])  # up
    bird_points.append([crop[0][0] + new_w, crop[0][1] + up + Y2])  # right
    bird_points.append([crop[0][0] + new_w - right - (frame_w - X1), crop[0][1] + new_h])  # down
...
def find_roi_clockwise(image,four_points,crop):
    ...
    points3 = []
    points3.append(four_points[0])
    points3.append(four_points[1])
    points3.append(four_points[2])
    c = find_angle(points3)

    points4 = []
    points4.append(four_points[1])
    points4.append(four_points[2])
    points4.append(four_points[3])
    d = find_angle(points4)
    ...
    points5 = []
    points5.append(four_points[3])
    points5.append(inters_point1)
    points5.append((frame_w, 0))
    a_first = find_angle(points5)
    ...
    points6 = []
    points6.append(four_points[3])
    points6.append(inters_point2)
    points6.append((frame_w, frame_h))
    b_first = find_angle(points6)
    if b_first > 90:
        b_first = 180 - b_first
    ...
    bird_points.append([crop[0][0] + left + (frame_w - X2), crop[0][1]]) #up
    bird_points.append([crop[0][0] + new_w,crop[0][1] + up + Y2]) #right
    bird_points.append([crop[0][0] + left + X1,crop[0][1] + new_h]) #down
    bird_points.append([crop[0][0], crop[0][1] + up + Y1]) #left
